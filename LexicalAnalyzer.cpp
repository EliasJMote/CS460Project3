...
vector<pair<string,token_type>> LexicalAnalyzer::GetCode () const
{
    return code;
}
...
token_type LexicalAnalyzer::GetToken ()
{
	...
	if (input.fail())
	{
        ...
        code.push_back(pair<string,token_type> ("", EOF_T));
    ...
    code.push_back(pair<string,token_type> (lexeme, token));
	return token;
}
